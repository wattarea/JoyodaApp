      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        <form action={formAction} className="space-y-6">
          ...
          <div className="text-center text-xs text-gray-500 mt-6">
            ...
            <button type="button" onClick={() => setShowTermsModal(true)} className="text-purple-600 hover:underline">
              Terms of Service
            </button>{" "}
            and{" "}
            <button type="button" onClick={() => setShowPrivacyModal(true)} className="text-purple-600 hover:underline">
              Privacy Policy
            </button>
          </div>
        </form>
