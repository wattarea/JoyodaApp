...
const cspHeader = `
  ...
  img-src 'self' data: blob: https://*.vercel.com https://vercel.com https://blob.vercel-storage.com https://*.supabase.co https://*.fal.ai https://*.fal.media https://fal.media https://cdn.fshn.ai https://*.fshn.ai;
